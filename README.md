...
- [LLMM](https://github.com/nsirivolu27/LLMM) — the product built on this relay, with its web console
- [lnkz-mcp](https://github.com/nsirivolu27/lnkz-mcp) — the MCP adapter as a standalone client, for pointing a laptop at a hosted relay
