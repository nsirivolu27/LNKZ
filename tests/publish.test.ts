...
import { looksLikeWrite, prepareCall, renderBody, type RemoteTool } from "../src/lnkz/publish/prepare.js";
import { configuredTargets, discoverTools, findTool } from "../src/lnkz/publish/targets.js";
