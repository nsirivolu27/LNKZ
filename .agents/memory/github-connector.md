...
The GitHub connector can read repository trees and update ordinary repository files, but the low-level Git Data tree-create endpoint may return a proxy 403/404, and paths under `.github/workflows/` may return a Cloudflare HTML response instead of JSON.
