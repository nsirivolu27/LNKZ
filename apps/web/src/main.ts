...
<main>
  ...
  <section class="section developer-section" id="developers">
    <div class="developer-copy">
       <p class="eyebrow">${icon("braces", 15)} REST, MCP, and a web console</p>
       <h2>One context layer. Multiple ways in.</h2>
      <p>
         Use the REST API from the console or other applications, or connect an MCP client
         over HTTP or stdio. All three use the same conversation workflow.
      </p>
