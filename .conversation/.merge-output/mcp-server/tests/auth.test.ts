...
test("password hashes use the fixed asynchronous scrypt format", async () => {
...
test("unknown password hash prefixes fail cleanly", async () => {
  await assert.rejects(
    verifyPassword("password", "argon2$1$2$3$4$5"),
